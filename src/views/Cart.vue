              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked=='1'}" @click="editCartItem('checked',item)">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="editCartItem('minu',item)">-</a>
      ...
      delCartItem(){
        axios.post("/users/cartDel",{
          ...
          if(res.status == '0'){
            ...
            this.cartList.splice(this.cartList.indexOf(this.delItem), 1);
          }
        });
      },
      editCartItem(opt, item){
        if(opt == 'add'){
          item.productNum++;
        }else if(opt == 'minu'){
